...
def parse_args():
    ...
    parser.add_argument('-g', '--gene',
                        help='gene',default="x00.txt", dest='gene', type=str)
...
def main():
    ...
    output= "output/"+os.path.basename(args.gene).split(".")[0]+'_match.txt'
    with open("/data4/ywang/literate/dict/all_gene.txt",'rb') as f1,open(args.gene,'r') as f2,open(output,'w') as f3:
